...
def test_hard_filter_ui_errors():
    ...
    history = [
        ...
        {"role": "user", "content": "LLM service error: Google API Error 429: quota exceeded"},
        {"role": "assistant", "content": "Great answer."},
    ]
    
    prompt = _build_feedback_prompt(s, history)
    
    assert "handle 502 rate limit errors carefully" in prompt, "Valid technical answer was dropped!"
